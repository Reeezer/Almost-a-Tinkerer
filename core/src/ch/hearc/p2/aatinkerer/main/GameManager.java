...
public class GameManager {
	...
	private GameManager() {
		...
		Contract splitterContract = new Contract(
				"Now we can finally glue everything together to make furniture! Place an assembler to select what you want to make, click on it, select a recipe you want to make and it will display the required ingredients.");
		...
		Contract finalContract = new Contract(
				"Thank you for making all the nice furniture! We actually don't have anything else for you to make, just do what you want now.");
