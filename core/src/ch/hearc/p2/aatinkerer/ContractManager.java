...
public class ContractManager
{
	...
	private ContractManager()
	{
		...
		//cutterContract.addRequestedItem(ItemType.WOODLOG, 1);
		...
		//furnaceContract.addRequestedItem(ItemType.PLANK, 1);
		//furnaceContract.addRequestedItem(ItemType.STICK, 1);
		...
		//mixerContract.addRequestedItem(ItemType.IRONPLATE, 1);
		...
		//pressContract.addRequestedItem(ItemType.CONCRETE, 1);
		...
		//assemblerContract.addRequestedItem(ItemType.GLUE, 1);
		...
		//splitterMergerContract.addRequestedItem(ItemType.FABRIC, 1); // FIXME peut être l'unlock avant comme ça on a déjà la production de matières premières pour les meubles?
